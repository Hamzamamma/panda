  ...
  return (
    <>
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
        ...
        >
          <span className="truncate max-w-[200px] md:max-w-xs font-mono text-xs">panda-dashboard.vercel.app</span>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div style={cardStyle} className="group">
          ...
          <div className="text-4xl font-black mb-2" style={{ fontFamily: "'Space Grotesk', sans-serif" }}>
      ...
      <div className="flex items-start gap-4 overflow-x-auto pb-4 pt-1">
        <div
          ...
          style={{ backgroundColor: 'white', border: '2px solid #000000', boxShadow: '4px 4px 0px 0px #000000' }}
        >
          <div
        ...
        >
          ...
          <div className="flex-1">
            <p className="text-sm font-bold leading-tight">Offer 5% off in checkout abandonment emails</p>
          </div>
          <button className="text-gray-400 hover:text-black"><X className="w-4 h-4" /></button>
        </div>
        ...
        <button
          ...
          style={{ backgroundColor: 'white', border: '2px solid #000000', boxShadow: '4px 4px 0px 0px #000000', color: '#9D4EDD' }}
        >
      ...
      <div>
        <div className="flex flex-col sm:flex-row sm:items-center justify-between mb-8 gap-4">
          <h2 className="text-2xl font-black" style={{ fontFamily: "'Space Grotesk', sans-serif" }}>Your Products</h2>
          <div className="flex gap-3">
            <Link href="/products">
              <button
                className="px-5 py-2.5 text-sm font-bold rounded-full transition-colors"
                style={{ backgroundColor: 'white', border: '2px solid #000000', boxShadow: '2px 2px 0px 0px #000000' }}
              >
                Browse all
              </button>
            </Link>
        ...
        {displayProducts.length > 0 ? (
            ...
            {displayProducts.map((product: any) => (
              <Link href={`/products/${encodeURIComponent(product.id)}/edit`} key={product.id}>
                <div className="group cursor-pointer">
                  ...
                  <h3 className="text-xs font-bold leading-tight mb-1 group-hover:underline line-clamp-2" style={{ color: '#000000' }}>
                    {product.title}
                  </h3>
                  <p className="text-xs text-gray-500 font-medium">From €{Number(product.price).toFixed(2)}</p>
                </div>
              </Link>
            ))}
            ...
            <Link href="/products/new">
              <div className="group cursor-pointer">
                <div
                  ...
                  style={{ backgroundColor: 'white', border: '2px dashed #d1d5db' }}
                >
          ...
          >
            ...
            <p className="text-gray-600 font-bold mb-4">You haven't created any products yet.</p>
            <Link href="/products/new">
              <button style={buttonBlackStyle}>
